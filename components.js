/* components.js — inyecta navbar y footer en todas las páginas */
...
function renderTopbar() {
  ...
  <div class="topbar">
    <div class="topbar-info">
      ...
      <span><i class="fas fa-clock"></i> Lun–Vie 8:00 – 17:00</span>
    </div>
  ...
  <nav class="navbar">
    <div class="navbar-inner">
      <a class="brand" href="${BASE}index.html">
        <div class="brand-escudo"><i class="fas fa-shield-alt"></i></div>
    ...
    <div class="footer-inner">
      <div class="footer-grid">
        <div class="footer-brand">
          <div class="escudo"><i class="fas fa-shield-alt"></i></div>
        ...
        <div class="footer-col">
          ...
          <p>Preceptoría Básica: int. 44</p>
          <a href="mailto:estradacolegio@gmail.com">estradacolegio@gmail.com</a>
          <br>
          <h4 style="margin-top:14px;">Admisión</h4>
          <a href="mailto:admision@colegioestrada.esc.edu.ar">admision@colegioestrada<br>.esc.edu.ar</a>
        </div>
      </div>
      <div class="footer-bottom">
        <span>© 2026 Instituto José Manuel Estrada — Av. San Martín 3701, Rafael Calzada, Buenos Aires</span>
        <span>Diseñado con ♥ para la comunidad educativa</span>
      </div>
    </div>
  </footer>`;
}
